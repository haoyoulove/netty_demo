...
//	 * 默认比较器，key不能为空，如果是其他比较器，看比较器是否允许为空
//	 */
//	public V put(K key, V value) {
//		// 从根结点开始判断
//		Entry<K,V> t = root;
//		if (t == null) {
//			// 这里是检查是否带有比较器，如果不带，抛出ClassCastException异常
...
//				// 小于0 k比t.key小，遍历左边。如果相等，直接把值赋予当前位置并且返回
//				if (cmp < 0)
//					t = t.left;
//				else if (cmp > 0)
//					t = t.right;
...
//			} while (t != null);
//		}
//		// 如果在上面都没找到要当前key结点位置上的值，加入新节点放到最后遍历位置的子节点。
...
//		//插入节点设置红色,如果设置黑色比较难调整
//		x.color = RED;
//
//		//调整到x不为null，x不为root。如果调整节点的父节点为红色，不需要调整
//		while (x != null && x != root && x.parent.color == RED) {
//			//判断插入节点的父节点是属于左子树还是右子树（祖父的左子还是右子）
